# =============================================================
# Script 07: KiMONo Network Inference — Normal Condition
# =============================================================
# Same as Script 06 but for normal (adjacent) tissue samples.
#
...
# Output: results/kimono/normal_kimono_result_new_pkn.csv
# =============================================================
...
transcriptome <- fread(file.path("data", "processed", "genie3NORMAL.csv"))
head(transcriptome)

mirna <- fread(file.path("data", "processed", "filtered_mirnas_normal.csv"))
head(mirna)
...
write.csv(network, file = file.path("results", "kimono", "normal_kimono_result_new_pkn.csv"))
message("Saved: results/kimono/normal_kimono_result_new_pkn.csv")
